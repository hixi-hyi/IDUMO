...
public class IdumoCanvas extends JPanel implements MouseListener, MouseMotionListener {
	...
	private IdumoItem			selectedItem		= null;
	...
	public void clear(Graphics g) {
		int h = win.getFrame().getHeight();
		int w = win.getFrame().getWidth();
	...
	public void mousePressed(MouseEvent e) {
		Point p = e.getPoint();
		selectedItem = searchIdumoItem(p.x, p.y);
		if (selectedItem != null) {
			selectOffsetX = p.x - selectedItem.getX();
			selectOffsetY = p.y - selectedItem.getY();
		}
		win.repaint();
	}
	...
	public void mouseDragged(MouseEvent e) {
		...
		Point p = e.getPoint();
		selectedItem.setPoint(p.x - selectOffsetX, p.y - selectOffsetY);
		win.repaint();
	}
