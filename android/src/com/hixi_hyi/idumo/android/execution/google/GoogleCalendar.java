...
public final class GoogleCalendar implements AndroidController {
	...
	private void chooseAccount() {
		accountManager.manager.getAuthTokenByFeatures(GoogleAccountManager.ACCOUNT_TYPE, AUTH_TOKEN_TYPE, null, activity, null, null, new AccountManagerCallback<Bundle>() {
	...
	// patchedCalendar.title = calendar.title + " UPDATED " + new DateTime(new
	// Date());
