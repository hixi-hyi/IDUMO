...
public class RoombaStopActivity extends AbstractAndroidActivity {
  @Override
  public void init() {
...
class RoombaStopComponent extends AbstractAndroidExecutionComponent {
  @Override
